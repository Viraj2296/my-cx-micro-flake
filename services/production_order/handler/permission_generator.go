...
func getOverview() PermissionResource {
	...
	permissionResource.ResourceDisplay = "Production Order"
	permissionResource.ComponentAction = "Get Production Order Overview"
	permissionResource.ActionDescription = "Get Production Order Overview"

	return permissionResource
}
func (v *ProductionOrderService) generatePermissions() {
	dbConnection := v.BaseService.ServiceDatabases[ProjectID]
	listOfComponents, _ := GetObjects(dbConnection, ProductionOrderComponentTable)
