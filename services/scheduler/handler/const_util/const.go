...
const (
	...
	SchedulerRecordTrailTable = "scheduler_record_trail"
	SchedulerComponentTable   = "scheduler_component"
	ScheduledOrderTable       = "scheduled_order_event"

	MouldingSchedulerComponent = "moulding_scheduler"
	AssemblySchedulerComponent = "assembly_scheduler"
	ToolingSchedulerComponent  = "tooling_scheduler"
