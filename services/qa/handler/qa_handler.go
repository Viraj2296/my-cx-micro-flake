...
func (v *QAService) loadFile(ctx *gin.Context) {
...
func (v *QAService) importObjects(ctx *gin.Context) {
...
// @Param Authorization header string true "Insert your access token" default(Bearer <Add access token here>)
// @Router /project/{projectId}/machines/component/{componentName}/import [get]
func (v *QAService) exportObjects(ctx *gin.Context) {
	// we will get the uploaded url
	projectId := ctx.Param("projectId")
	componentName := ctx.Param("componentName")
...
func (v *QAService) getTableImportSchema(ctx *gin.Context) {
	componentName := ctx.Param("componentName")
...
func (v *QAService) getExportSchema(ctx *gin.Context) {
	componentName := ctx.Param("componentName")
...
func (v *QAService) getObjects(ctx *gin.Context) {
...
// @Param Authorization header string true "Insert your access token" default(Bearer <Add access token here>)
// @Router /project/{projectId}/machines/component/{componentId}/records [get]
func (v *QAService) getGroupBy(ctx *gin.Context) {
...
// @Param Authorization header string true "Insert your access token" default(Bearer <Add access token here>)
// @Router /project/{projectId}/machines/component/{componentId}/records [get]
func (v *QAService) getCardViewGroupBy(ctx *gin.Context) {
...
func (v *QAService) getCardView(ctx *gin.Context) {
...
func (v *QAService) deleteValidation(ctx *gin.Context) {
...
func (v *QAService) deleteResource(ctx *gin.Context) {
...
func (v *QAService) updateResource(ctx *gin.Context) {
...
func (v *QAService) createNewResource(ctx *gin.Context) {
...
func (v *QAService) getNewRecord(ctx *gin.Context) {
...
func (v *QAService) getRecordFormData(ctx *gin.Context) {
...
func (v *QAService) getSearchResults(ctx *gin.Context) {
