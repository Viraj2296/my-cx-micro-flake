...
func (v *IncidentService) CreateUserRecordMessage(projectId string, componentName, message string, recordId int, userId int, existingData *component.GeneralObject, updatedData *component.GeneralObject) error {
	...
	recordTrail := IncidentRecordTrail{
		RecordId:      recordId,
...
func (v *IncidentService) getComponentRecordTrails(ctx *gin.Context) {
	...
	listOfObjects, err := GetConditionalObjectsOrderBy(dbConnection, IncidentRecordTrailTable, conditionString, orderByCondition)
	if err != nil {
