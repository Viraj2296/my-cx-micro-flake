...
func (v *FixedAssetService) CreateUserRecordMessage(projectId string, componentName, message string, recordId int, userId int, existingData *component.GeneralObject, updatedData *component.GeneralObject) error {
	...
	recordTrail := FixedAssetRecordTrail{
		RecordId:      recordId,
...
func (v *FixedAssetService) getComponentRecordTrails(ctx *gin.Context) {
	...
	listOfObjects, err := GetConditionalObjectsOrderBy(dbConnection, FixedAssetRecordTrailTable, conditionString, orderByCondition)
	if err != nil {
