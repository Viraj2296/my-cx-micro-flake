...
func (v *ToolingService) CreateUserRecordMessage(projectId string, componentName, message string, recordId int, userId int, existingData *component.GeneralObject, updatedData *component.GeneralObject) error {
	...
	recordTrail := ToolingRecordTrail{
		RecordId:      recordId,
...
func (v *ToolingService) getComponentRecordTrails(ctx *gin.Context) {
	...
	listOfObjects, err := GetConditionalObjectsOrderBy(dbConnection, ToolingRecordTrailTable, conditionString, orderByCondition)
	if err != nil {
