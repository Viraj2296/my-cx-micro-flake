...
func (v *ManufacturingService) getSchedulerOverView(ctx *gin.Context) {
	...
	//listOfTotalObjects, _ := GetObjects(dbConnection, ScheduledOrderTable)
	//
...
func (v *ManufacturingService) loadFile(ctx *gin.Context) {
...
func (v *ManufacturingService) importObjects(ctx *gin.Context) {
...
// @Param Authorization header string true "Insert your access token" default(Bearer <Add access token here>)
// @Router /project/{projectId}/machines/component/{componentName}/import [get]
func (v *ManufacturingService) exportObjects(ctx *gin.Context) {
	// we will get the uploaded url
	projectId := ctx.Param("projectId")
	componentName := ctx.Param("componentName")
...
func (v *ManufacturingService) getTableImportSchema(ctx *gin.Context) {
	componentName := ctx.Param("componentName")
...
func (v *ManufacturingService) getExportSchema(ctx *gin.Context) {
	componentName := ctx.Param("componentName")
...
func (v *ManufacturingService) getObjects(ctx *gin.Context) {
...
// @Param Authorization header string true "Insert your access token" default(Bearer <Add access token here>)
// @Router /project/{projectId}/machines/component/{componentId}/records [get]
func (v *ManufacturingService) getGroupBy(ctx *gin.Context) {
...
// @Param Authorization header string true "Insert your access token" default(Bearer <Add access token here>)
// @Router /project/{projectId}/machines/component/{componentId}/records [get]
func (v *ManufacturingService) getCardViewGroupBy(ctx *gin.Context) {
...
func (v *ManufacturingService) getCardView(ctx *gin.Context) {
...
func (v *ManufacturingService) deleteValidation(ctx *gin.Context) {
...
func (v *ManufacturingService) deleteResource(ctx *gin.Context) {
...
func (v *ManufacturingService) updateResource(ctx *gin.Context) {
...
func (v *ManufacturingService) createNewResource(ctx *gin.Context) {
...
func (v *ManufacturingService) getNewRecord(ctx *gin.Context) {
...
func (v *ManufacturingService) getRecordFormData(ctx *gin.Context) {
...
func (v *ManufacturingService) getSearchResults(ctx *gin.Context) {
