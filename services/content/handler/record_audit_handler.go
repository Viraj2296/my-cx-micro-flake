...
func (v *ContentService) CreateUserRecordMessage(projectId string, componentName, message string, recordId int, userId int, existingData *component.GeneralObject, updatedData *component.GeneralObject) error {
	...
	recordTrail := ContentRecordTrail{
		RecordId:      recordId,
...
func (v *ContentService) getComponentRecordTrails(ctx *gin.Context) {
	...
	listOfObjects, err := GetConditionalObjectsOrderBy(dbConnection, ContentRecordTrailTable, conditionString, orderByCondition)
	if err != nil {
