...
func (v *MachineService) CreateUserRecordMessage(projectId string, componentName, message string, recordId int, userId int, existingData *component.GeneralObject, updatedData *component.GeneralObject) error {
	...
	recordTrail := MachinesRecordTrail{
		RecordId:      recordId,
...
func (v *MachineService) getComponentRecordTrails(ctx *gin.Context) {
	...
	listOfObjects, err := GetConditionalObjectsOrderBy(dbConnection, MachinesRecordTrailTable, conditionString, orderByCondition)
	if err != nil {
