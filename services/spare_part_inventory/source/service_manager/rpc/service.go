...
// NewRPCService initializes a new Actions instance
func NewRPCService(logger *logging.Logger, repository repository.Repository, componentManager *component_processor.ComponentManager) *Service {
	return &Service{
		Logger:           logger,
