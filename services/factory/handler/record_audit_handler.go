...
func (v *FactoryService) CreateUserRecordMessage(projectId string, componentName, message string, recordId int, userId int, existingData *component.GeneralObject, updatedData *component.GeneralObject) error {
	...
	recordTrail := FactoryRecordTrail{
		RecordId:      recordId,
...
func (v *FactoryService) getComponentRecordTrails(ctx *gin.Context) {
	...
	listOfObjects, err := GetConditionalObjectsOrderBy(dbConnection, FactoryRecordTrailTable, conditionString, orderByCondition)
	if err != nil {
