...
func FormatStringHTML(htmlContent string) string {
	htmlContent = strings.Replace(htmlContent, "&lt;", "<", -1)
	htmlContent = strings.Replace(htmlContent, "&gt;", ">", -1)
	htmlContent = strings.Replace(htmlContent, "</p><p>", "\n", -1)
	htmlContent = strings.Replace(htmlContent, "&nbsp;", " ", -1)

	htmlContent = strings.Replace(htmlContent, "\\", "", -1)
	htmlContent = strings.Replace(htmlContent, "<p><!DOCTYPE html>", "<!DOCTYPE html>", -1)
	htmlContent = strings.Replace(htmlContent, "</html></p>\"", "</html>", -1)
	htmlContent = strings.Replace(htmlContent, "&quot;", "\"", -1)
	htmlContent = strings.Replace(htmlContent, "<br>", "", -1)
